...
class LoginViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loginConHuella(
        ...
        BiometricHelper.prompt(
            activity = activity,
            onSuccess = {
                val uidLocal = SessionManager.obtenerUltimoUid(activity)
                    ?: SessionManager.obtenerUid(activity)
                ...
                if (uidLocal != null) {
                    viewModelScope.launch {
                        ...
                        SessionManager.guardarSesion(activity, uidLocal)
    ...
    fun olvidarDispositivo(context: Context) {
        SessionManager.olvidarBiometriaCompleta(context)
